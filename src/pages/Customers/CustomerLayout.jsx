...
const SidebarContent = ({ isActive, onNavigate }) => (
  <>
    ...
    <div className="mx-4 mb-6 bg-orange-500 rounded-2xl p-4 text-white">
      <div className="text-lg font-extrabold mb-1">Get 20% OFF</div>
      <div className="text-orange-100 text-xs mb-3">on your first order!</div>
      <button
        onClick={() => onNavigate("/customer/browse")}
        className="w-full bg-white text-orange-500 text-xs font-bold py-2 rounded-xl hover:bg-orange-50 transition-colors"
      >
        Order Now
      </button>
    </div>

import { useState, useEffect } from "react";
  ...
  export default function SettingsPage() {
    ...
    const getToken = () => localStorage.getItem("customerToken"); // use whatever key you store customer token under
    ...
    const handleSave = async () => {
      setSaving(true);
      try {
        const res = await fetch(`${BASE_URL}/api/customers/notification-preferences`, {
          method: "PATCH",
          headers: {
